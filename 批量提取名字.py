...
import sys
import os 
data_dir = r"G:\研究生文件夹（深大）\机器学习\磁瓦\磁瓦(标注数据)\dataset\val/" 
file_list = [] 
write_file_name = r'G:\PyTorch-YOLOv3-master\data\valid.txt'
...
for current_line in range(len(file_list)): 
     write_file.write( 'G:\PyTorch-YOLOv3-master\data\images/' + file_list[current_line] + '\n')
write_file.close()
